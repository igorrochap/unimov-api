...
O campo `credencial` aceita **email** ou **CPF**. A API detecta automaticamente qual e qual:
...
app/
├── Actions/Auth/
│   ├── AutenticaUsuario.php     # Logica de login (email ou CPF)
│   └── DeslogaUsuario.php       # Logica de logout
├── DTO/
│   ├── Request/Auth/
│   │   └── LoginDTO.php         # Dados de entrada do login
│   └── Response/Auth/
│       └── UsuarioAutenticado.php  # Dados de saida do usuario
├── Http/
│   ├── Controllers/Auth/
