...
test('cria periodo', function () {
    ...
    $dto = new PeriodoDTO($municipio->id, 'Semestre Letivo 2026.1', new \DateTime('2026-03-10 08:00:00'), new \DateTime('2026-03-20 23:59:59'), new \DateTime('2026-03-25 07:00:00'), new \DateTime('2026-07-15 22:00:00'));
